...
class DatesDaoTest {
    ...
    private val date1 = DateItem("name1", 1000, "type1")
    private val date2 = DateItem("name2", 1000, "type2")
    private val date3 = DateItem("name3", 1000, "type3")
    ...
    fun testInsertAndDeleteDate() = runBlocking {
        val dateItem = DateItem("name4", 1000, "type4")
